...
function setup(options = {
    loggedInUserIdValueIsEmpty: false,
}) {
    const loggedInUserIdMock = options.loggedInUserIdValueIsEmpty ? null : loggedInUserId;

    render(
        <MemoryRouter>
            <UserContext.Provider value={{ loggedInUserId: loggedInUserIdMock }}>
...
describe("PostButtons component", () => {
    ...
    it("does not render the owner buttons when the user is not logged in", () => {
        setup({
            loggedInUserIdValueIsEmpty: true,
        });
