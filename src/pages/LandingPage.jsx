                ...
                <section className="hero-section" aria-labelledby="main-heading">
                    <div className="hero-content">
                        ...
                        <div className="cta-buttons">
                            <a href="#signup" className="cta-button primary-cta">Join Free Today</a>
                            <a href="#learn-more" className="cta-button secondary-cta">How It Works</a>
                        </div>
                    </div>
                </section>
                ...
                <section className="features-section" aria-labelledby="features-heading">
                    ...
                    <div className="features-container">
                        ...
                        <article className="feature-card" aria-labelledby="groups-heading">
                            ...
                            <h3 id="groups-heading" className="feature-title">Interest Groups</h3>
                            <p className="feature-description">Join communities that share your passions and hobbies, from travel to music and beyond.</p>
                        </article>
                    </div>
                </section>
            </div>
